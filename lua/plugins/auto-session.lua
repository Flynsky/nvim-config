return {
  ...
  keys = {
    ...
    { '<leader>r', '<cmd>SessionSearch<CR>', desc = 'Session search' },
    { '<leader>w', '<cmd>SessionSave<CR>', desc = 'Save session' },
    { '<leader>e', '<cmd>SessionToggleAutoSave<CR>', desc = 'Toggle autosave' },
  },
